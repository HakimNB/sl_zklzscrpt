...
--
-- Host: 127.0.0.1    Database: amc_game_backup
-- ------------------------------------------------------
...
--
-- Current Database: `amc_game_backup`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `amc_game_backup` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
-- Dump completed on 2018-08-29 14:46:13
